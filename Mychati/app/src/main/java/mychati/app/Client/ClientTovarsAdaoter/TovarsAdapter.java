...
public class TovarsAdapter {
    ...
    private String TovarStatus,ProductTime,TovarName,TovarOpisanie,TovarPrice,TovarImage,ShopPhone,ShopUid;

    public TovarsAdapter(){

    }

    public TovarsAdapter(String TovarStatus,String ProductTime,String tovarName, String tovarOpisanie, String tovarPrice, String tovarImage, String shopPhone, String shopUid) {
