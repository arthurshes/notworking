 ...
 * Use the {@link OrtoFragment#newInstance} factory method to
...
public class OrtoFragment extends Fragment {
     ...
     * @return A new instance of fragment OrtoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static OrtoFragment newInstance(String param1, String param2) {
        OrtoFragment fragment = new OrtoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     Orto= inflater.inflate(R.layout.fragment_orto, container, false);
        apteka= FirebaseDatabase.getInstance().getReference().child("shops");
        recyclerView=Orto.findViewById(R.id.rec_orto);
        orto="Ортопедия";
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<ShopAdapter> options=new FirebaseRecyclerOptions.Builder<ShopAdapter>()
                .setQuery(apteka.orderByChild("MagCategory").equalTo(orto),ShopAdapter.class).build();
